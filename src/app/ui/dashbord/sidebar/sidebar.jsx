  ...
  return (
    <div className='bg-[#212B39] h-[100vh] w-[20%] text-[#D2D9E4] p-6 absolute top-0 lg:left-0 -left-[100%]'>
      ...
      <div className='flex flex-col'>
        ...
        <button className='w-full hover:text-[#131720] hover:bg-[#3EBF77] bg-[#3ebf7878] transition-all flex items-center text-[16px] my-2 py-4 px-4 font-semibold border rounded-lg border-slate-600' onClick={() => router("/")}><TbLogout2 className='mr-2' />Log Out</button>
      </div>
    </div>
  )
}
